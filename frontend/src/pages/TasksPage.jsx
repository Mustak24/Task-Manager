        ...
        <div className="w-full h-full items-center flex flex-col">
            ...
            <div className="w-full max-w-[1024px] mt-5 px-5 pb-10">
                <div className="flex items-center justify-between">
                    ...
                    {
                        userInfo.role !== 'user' ? (
                            <Button onClick={() => {setTaskModalVisible(true)}} >
                                Assign Task
                            </Button>
                        ) : null
                    }         
                ...
                <label className="mb-10 mt-5 px-5 h-10 rounded-lg bg-zinc-800 flex items-center gap-4">
                    <IoSearchOutline />
...
function TaskAssignModal({visible, setVisible}) {
    ...
    return (
        ...
        >
            ...
            <div className="rounded-lg bg-zinc-800 w-full px-5 h-10 flex items-center justify-between" >
                <div>Date</div>
            ...
            <div>
                <button 
                    ...
                    className="rounded-lg bg-zinc-800 w-full p-2 flex items-center justify-between gap-2 cursor-pointer" 
                >
